...
export const MODULOS_DISPONIBLES = [
  ...
  { key: "GestionAumentos",    label: "Gestión de Aumentos" },
...
const GRUPOS = [
  ...
  { label: "Beneficios",     keys: ["Vacaciones", "Incapacidades", "HorasExtras", "Aguinaldo", "Liquidaciones", "GestionAumentos", "HistorialSalarial", "HistorialBoletas"] },
