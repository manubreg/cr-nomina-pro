...
export default function PlanillaDetalleModal({ planilla, onClose }) {
  ...
  useEffect(() => {
    Promise.all([
      base44.entities.PlanillaDetalle.filter({ planilla_id: planilla.id }),
      base44.entities.MovimientoPlanilla.filter({ planilla_id: planilla.id }),
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="text-xs font-medium text-gray-800">{emp ? `${emp.nombre} ${emp.apellidos}` : d.empleado_id}</div>
